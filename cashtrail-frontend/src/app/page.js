...
export default function ExpenseTable() {
  ...
  return (
    <div className="w-screen h-screen bg-white">
      ...
      <div className=" relative h-90 w-full bg-blue-500 p-4">
        ...
        {/* Expenses Table F4F3EF */}
        <div className="flex justify-center items-center">
          
          <div className="flex justify-center items-center w-[1800px] rounded-lg ">
            <div className="bg-white rounded-lg p-4 m-4 bg-white1 border-gray-200 w-[1800px]">
              {/* Header Section with Title and Buttons */}
              <div className="flex justify-between items-center p-4">
                <div className="space-x-4 item-right">
              ...
              {/* Table Section */}
              <table className="w-full border-collapse text-black bg-white1 bg-white h-[500px]">
                <thead>
